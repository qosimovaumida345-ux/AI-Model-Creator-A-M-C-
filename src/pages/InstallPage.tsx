          ...
          {installer && (
            ...
            >
              ...
              <p className="text-xs text-white/30 mb-4">{installer.requirements}</p>
                ...
                {installer.isAvailable && installer.downloadUrl ? (
                  <a
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      ...
                      className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 border border-white/10
                                 text-white/30 font-medium cursor-not-allowed"
                    >
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <p className="text-xs text-white/30">
                      Desktop installer is not built yet. You can build from source using the instructions below,
                      or use the web version at{' '}
                      <a href="https://ai-model-creator-a-m-c.onrender.com" className="text-cyan-400 hover:underline">
                        ai-model-creator-a-m-c.onrender.com
                      </a>
                    </p>
                  </div>
                )}
